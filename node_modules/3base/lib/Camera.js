...
export default class Camera extends SceneObject {
  ...
  constructor(scene, x = 0, y = 0, z = 0) {
    ...
    this.lens = new THREE.PerspectiveCamera(45, this.scene.manager.renderer.domElement.width / this.scene.manager.renderer.domElement.height, this.near, this.far);
